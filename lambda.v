...
Local Lemma pat3 t s : t.-1 < s -> t < s.+1.
Proof. by case: t. Qed.

Local Lemma pat4 t s r : t + s < r -> t < r.
Proof. by apply/leq_trans/leq_addr. Qed.

Local Lemma pat5 t s r : t + s < r -> s < r.
Proof. by apply/leq_trans/leq_addl. Qed.

Local Lemma pat6 s i : (s + i).+1 == i = false.
Proof. by elim: i => // *; rewrite eqSS addnS. Qed.
...
Lemma pat7 n j i : n - (j < n) < i -> i < n -> false.
Proof.
  case: n => // n.
  case: (j < n.+1).
