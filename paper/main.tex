...
\begin{defn}
 ...
 \begin{description}
  ...
  \item[Var] \[ \frac{\Gamma \vdash t {\colon} {\star} \text{ or } {\square} \quad \text{$v$は$\Gamma$に自由に出現しない}}{\Gamma, v {\colon} t \vdash v {\colon} t} \]
  \item[Weak] \[ \frac{\Gamma \vdash t {\colon} {\star} \text{ or } \square \quad \Gamma \vdash m {\colon} u \quad \text{$v$は$\Gamma$に自由に出現しない}}{\Gamma, v {\colon} t \vdash m {\colon} u} \]
