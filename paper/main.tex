...
\begin{defn}
 ...
 \begin{description}
  ...
  \item[Var] \[ \frac{\Gamma \vdash t : \star \text{ or } \square \quad \text{$v$は$\Gamma$に自由に出現しない}}{\Gamma, v : t \vdash v : t} \]
  \item[Weak] \[ 
             \frac{\Gamma \vdash t : \star \text{ or } \square \quad \Gamma \vdash m : u \quad \text{$v$は$\Gamma$に自由に出現しない}}{\Gamma, v : t \vdash m : u}
 \]
  \item[\Pi] TODO
  \item[\lambda] TODOH
  \item[App] tODO
